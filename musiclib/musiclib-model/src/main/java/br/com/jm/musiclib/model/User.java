...
public class User {
	...
	/**
	 * Map contendo o número de vezes que uma determinada música foi
	 * executada. A chave é o identificador da música, e o valor o número
	 * de vezes.
	 */
	 ...
	 * 
	 * @param id Identificador interno do usuário.
	 * @param name Nome.
	 * @param login Login.
	 * @param password Senha.
	 * @param playlists Lista de playlists do usuário.
	 * @param executions Map contendo o número de execuções de cada música.
	 */
	 ...
	 * @param musicaId Música a ter o número de execuções incrementada.
	 */
	 ...
	 * @param id Indeitificador interno. 
	 */
     ...
     * @param playlists Conjunto de playlists do usuário.
     */
